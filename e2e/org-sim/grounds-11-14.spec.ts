...
/**
 * GROUNDS 11 TO 14, STRICTLY SEQUENTIALLY. GROUND 11 IS THE PAYWALL TEST.
 *
...
const SPECS: Spec[] = [
  {
    ...
    lead: { email: 'hafsah@meridianhealth.test', role: 'Runs the weekly read' },
    parties: [
      { email: 'abubakar@meridianhealth.test', role: 'Delivery' },
      { email: 'kavon@meridianhealth.test', role: 'Field' },
      { email: 'adam@meridianhealth.test', role: 'Advisor' },
      { email: 'nate@meridianhealth.test', role: 'Contractor' },
  ...
  },
  {
    ...
    lead: { email: 'kennedy@meridianhealth.test', role: 'Raised the concern' },
    parties: [
      { email: 'nate@meridianhealth.test', role: 'The work that is off track' },
      { email: 'adam@meridianhealth.test', role: 'Second read on the same work' },
    ],
  ...
  },
  {
    ...
    lead: { email: 'hafsah@meridianhealth.test', role: 'Chairing the strategy round' },
    parties: [
      { email: 'kennedy@meridianhealth.test', role: 'Engineering lead' },
      { email: 'abubakar@meridianhealth.test', role: 'Delivery lead' },
      { email: 'maureen@meridianhealth.test', role: 'Operations lead' },
    ],
  ...
  },
  {
    ...
    lead: { email: 'maureen@meridianhealth.test', role: 'Runs the field team' },
    parties: [
      { email: 'abubakar@meridianhealth.test', role: 'Field officer' },
      { email: 'kavon@meridianhealth.test', role: 'Field officer' },
      { email: 'adam@meridianhealth.test', role: 'Field officer' },
      { email: 'nate@meridianhealth.test', role: 'Field officer' },
      { email: 'ejiro@meridianhealth.test', role: 'Field officer' },
      { email: 'eric@meridianhealth.test', role: 'Field officer' },
      { email: 'hafeezah@meridianhealth.test', role: 'Field officer' },
      { email: 'kennedy@meridianhealth.test', role: 'Field officer' },
    ],
...
for (const s of SPECS) {
  test(`Ground ${s.n}: ${s.card}`, async ({ browser }) => {
    ...
    fs.writeFileSync(path.join(OUT, 'grounds-11-14.log'), LOG.join('\n'));
    await c.close();
