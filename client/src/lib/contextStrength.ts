/**
 * Shared with the API deliberately: api/src/modules/documents/what-this-ground-can-tell-you.ts
 *
 * A copy rather than a package, because the two build separately and a
 * shared-workspace dependency for one pure function is a lot of machinery for
 * nothing. Its own test file guards the wording on this side, so a drift shows
 * up as a failing assertion rather than as two screens disagreeing.
 */
/**
