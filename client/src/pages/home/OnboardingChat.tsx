...
function stepContent(step: number, mode: string, ctx: Ctx): string {
  ...
  switch (step) {
    ...
    case 10:
      return `How long do you need this record for?\n\nUse this to decide. If you need a quick resolution and everybody is willing, one month. If this needs time to play out with multiple check-ins, three months. If this could end up in front of a board, a lawyer, or an external party, six months or more. If you just need everybody on record right now and you are done, one session only.`
    case 11:
